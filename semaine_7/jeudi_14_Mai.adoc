...
* {site}/{semaine}/correction-exo-maths-jeudi-14.pdf[Corrige la fiche d’exercices, window = "_blank"] 
...
Révision en vue du vote pour le prix littéraire +
...
| 
.*Pour le lundi 18 Mai*
*Orthographe* : Bien revoir les 12 mots de la liste 27 et la préparation de dictée +
*Grammaire* : Apprendre la leçon sur l'imparfait (les verbes du 3 ème groupe : pouvoir, vouloir, venir, prendre))
